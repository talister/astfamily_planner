...
#        expected = ['2015 12 10 18:00', '21 11 39.20', '-12 34 06.3',   58.5  18.8  15.0    0.89    072.8    100  +39   -05   0.00   066  -15]
        ...
        expected = (ephem_start, 5.5486346615349067, -0.21936045307765661, 14.970369998574069, 0.89322757180821588, 38.574338332084082, 77.430833333333339, 0.32823279468835626)
...
class TestCallComputeEphem(unittest.TestCase):
    ...
    def test_ephem_566_K91_Dec2015(self):
        ...
        expected = [['2015 12 10 18:00', '21 11 39.20', '-12 34 06.3', '18.8', '15.0', ' 0.89', '+38', '0.01', ' 66', '-15', '+043', '+03:27']]
    ...
    def test_ephem_566_K91_Oct2015(self):
        ...
        expected = [['2015 10 10 18:00', '20 06 38.62', '-16 32 38.9', '21.5', '14.5', ' 0.33', '+72', '0.05', '128', '-40', '+085', '+00:31'],
                    ['2015 10 10 19:00', '20 06 39.98', '-16 32 34.8', '21.5', '14.5', ' 0.33', '+63', '0.04', '127', '-50', '+080', '+01:31'],
                    ['2015 10 10 20:00', '20 06 41.35', '-16 32 30.6', '21.5', '14.5', ' 0.34', '+52', '0.04', '126', '-57', '+070', '+02:32'],
                    ['2015 10 10 21:00', '20 06 42.72', '-16 32 26.3', '21.5', '14.5', ' 0.34', '+39', '0.04', '126', '-59', '+059', '+03:32'],
                   ]
